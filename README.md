...
- [.NET SDK](https://dotnet.microsoft.com/download) (8.0 or later) (The script also checked on the .NET 6 so you can youse the trx2xlsx.cs in .NET 6 solution, don`t forget to include EPPlus PackageReference into .cproj file)
